...
procedure InternalUpdate(Self: PRGBLed);

implementation

operator = (const AValue1, AValue2: TRGBColor): Boolean; inline;
begin
  Result := (AValue1.R = AValue2.R) and (AValue1.G = AValue2.G) and (AValue1.B = AValue2.B);
end;
...
procedure InternalUpdate(Self: PRGBLed); assembler;
label
  exit, bitloop, rgbloop, ledloop, skipoff;
asm
         PUSH    R16 {Pin} {VPort} {VMaskOff}         {2}
